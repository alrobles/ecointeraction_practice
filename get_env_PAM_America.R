...
rodentiaMapsAmerica <- terra::crop(rodentiaMaps, America)
...
get_env_PAM  <- function(x){
  host <- rodentiaMapsAmerica[x]
  spEnvDf <- terra::extract(americaPCA, host )
